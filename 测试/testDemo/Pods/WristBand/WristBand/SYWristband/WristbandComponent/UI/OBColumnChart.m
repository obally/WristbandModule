...
//        [self.layerArr addObject:shapeLayer];
    ...
    if (_xShowInfoText.count == _valueArr.count&&_xShowInfoText.count>0) {
        ...
        for (NSInteger i = 0; i<_xShowInfoText.count; i++) {
            ...
            textLayer.frame = CGRectMake( i * (count * _columnWidth + _typeSpace + _columnSpace) + _typeSpace + _originSize.x - kWidth(8) , CGRectGetHeight(self.frame) - _originSize.y+5,wid + kWidth(8), size.height + 10);
